...
public class FadeManager : SingletonMonoBehaviour<FadeManager>
{
	...
	public void LoadScene(float _time, string _sceneName, Action _beforAction = null)
	{
		StartCoroutine(CrossFade(_time, () => {
			if (_beforAction != null) { _beforAction(); }
	...
	public IEnumerator FadeOut(float _time, Action _afterAction = null)
	{
		if (this.state != FadeState.Free) { yield break; }
