...
namespace Game.Player
{
	...
	public sealed class VeronicaPlayer : RiaPlayer
	{
		// 通常ショット
		...
		// CharacterScriptの上書き
		private new VeronicaPlayerScript Script;
		...
		public VeronicaPlayer(GameObject _go, RiaCharacterScript _script, PlayerNumber _playerNumber) : base(_go, _script, _playerNumber)
		{
			// CharacterScriptの上書き
			this.Script = _script as VeronicaPlayerScript;
		...
		private void NormalShot()
		{
			...
			if (RiaInput.Instance.GetPush(RiaInput.KeyType.NormalShot, this.PlayerNumber))
			{
				...
				if (script.shotInterval <= shotElapsedTime)
				{
					...
					this.BulletManger.CreateVeronicaBullet(
