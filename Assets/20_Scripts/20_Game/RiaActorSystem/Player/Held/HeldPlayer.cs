...
namespace Game.Player
{
	...
	public sealed class HeldPlayer : RiaPlayer
	{
		// 通常ショット
		...
		// CharacterScriptの上書き
		private new HeldPlayerScript Script;
		...
		public HeldPlayer(GameObject _go, RiaCharacterScript _script, PlayerNumber _playerNumber) : base(_go, _script, _playerNumber)
		{
			// CharacterScriptの上書き
			this.Script = _script as HeldPlayerScript;
