...
namespace Game.Enemy
{
	...
	public sealed class BossEnemy : RiaEnemy
	{
		private new BossEnemyScript Script;
		...
		public class Shooter
		{
			...
			public Shooter(BossEnemyScript.ShooterParam _param, EnemyBulletActorManager _manager, Transform _trans)
			{
			...
			public void Update()
			{
				...
				{
					this.manager.CreateBossEnemyBullet(this.trans.position);
		...
		public BossEnemy(GameObject _go, RiaCharacterScript _script, PlayerNumber _playerNumber) :
			base(_go, _script, _playerNumber)
		{
			this.Script = _script as BossEnemyScript;
