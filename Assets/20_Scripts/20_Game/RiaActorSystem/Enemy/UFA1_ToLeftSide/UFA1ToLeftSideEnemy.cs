...
namespace Game.Enemy
{
	...
	public class UFA1ToLeftSideEnemy : RiaEnemy
	{
		private new UFA1ToLeftSideEnemyScript Script;
		...
		public class Shooter
		{
			...
			public Shooter(UFA1ToLeftSideEnemyScript.ShooterParam _param, EnemyBulletActorManager _manager,
				Transform _trans)
			{
		...
		public UFA1ToLeftSideEnemy(GameObject _go, RiaCharacterScript _script, PlayerNumber _playerNumber) : base(_go,
			_script, _playerNumber)
		{
			this.Script = _script as UFA1ToLeftSideEnemyScript;
