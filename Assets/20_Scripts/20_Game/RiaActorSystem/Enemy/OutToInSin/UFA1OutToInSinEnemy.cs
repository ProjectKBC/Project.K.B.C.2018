...
namespace Game.Enemy
{
	...
	public sealed class UFA1OutToInSinEnemy : RiaEnemy
	{
		private new UFA1OutToInSinEnemyScript Script;
		...
		public class Shooter
		{
			...
			public Shooter(UFA1OutToInSinEnemyScript.ShooterParam _param, EnemyBulletActorManager _manager, Transform _trans)
			{
			...
			public void Update()
			{
				...
				{
					this.manager.CreateOutToInSinEnemyBullet(this.trans.position);
		...
		public UFA1OutToInSinEnemy(GameObject _go, RiaCharacterScript _script, PlayerNumber _playerNumber) :
			base(_go, _script, _playerNumber)
		{
			this.Script = _script as UFA1OutToInSinEnemyScript;
