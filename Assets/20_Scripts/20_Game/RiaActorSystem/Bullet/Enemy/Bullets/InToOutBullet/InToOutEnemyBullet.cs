...
{
	public sealed class InToOutEnemyBullet : RiaEnemyBullet
	{
		private Vector3 myAppearPos;
		private Vector3 playerPos;
		
		// CharacterScriptの上書き
		private new InToOutEnemyBulletScript Script;

		public InToOutEnemyBullet(GameObject _go, RiaCharacterScript _script, PlayerNumber _playerNumber) : base(_go, _script, _playerNumber)
		{
			// CharacterScriptの上書き
			this.Script = _script as InToOutEnemyBulletScript;
