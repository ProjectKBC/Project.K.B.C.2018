...
{
	public sealed class OutToInSinEnemyBullet : RiaEnemyBullet
	{
		// CharacterScriptの上書き
		private new OutToInSinEnemyBulletScript Script;
		private Vector3 myAppearPos;
		private Vector3 playerPos;

		public OutToInSinEnemyBullet(GameObject _go, RiaCharacterScript _script, PlayerNumber _playerNumber) : base(_go, _script, _playerNumber)
		{
			// CharacterScriptの上書き
			this.Script = _script as OutToInSinEnemyBulletScript;
