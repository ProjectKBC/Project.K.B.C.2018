...
{
	public sealed class GeneralSpecialBullet : RiaPlayerBullet
	{
		// CharacterScriptの上書き
		private new GeneralSpecialBulletScript Script;

		// キャッシュ
		private SpriteRenderer spRender;

		public GeneralSpecialBullet(GameObject _go, RiaCharacterScript _script, PlayerNumber _playerNumber) : base(_go, _script, _playerNumber)
		{
			// CharacterScriptの上書き
			this.Script = _script as GeneralSpecialBulletScript;
