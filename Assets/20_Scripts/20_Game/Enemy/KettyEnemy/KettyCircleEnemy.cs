...
{
    public sealed class KettyCircleEnemy : KettyEnemy
    {
        ...
        [SerializeField] private CircleEnemyDebugParam debug = null;
        ...
        private void CircleMove(float _radius, Vector2 _endStraightPos, float _straightSpeed = 10)
        {
